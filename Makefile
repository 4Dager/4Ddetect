...
OBJ=http_stream.o gemm.o utils.o cuda.o convolutional_layer.o list.o image.o activations.o im2col.o col2im.o blas.o crop_layer.o dropout_layer.o maxpool_layer.o softmax_layer.o data.o matrix.o network.o connected_layer.o cost_layer.o parser.o option_list.o 4d_net.o detection_layer.o  route_layer.o writing.o box.o nightmare.o normalization_layer.o avgpool_layer.o coco.o dice.o  detector.o layer.o compare.o  local_layer.o swag.o shortcut_layer.o activation_layer.o rnn_layer.o gru_layer.o rnn.o rnn_vid.o crnn_layer.o demo.o tag.o  batchnorm_layer.o region_layer.o reorg_layer.o reorg_old_layer.o super.o tree.o yolo_layer.o upsample_layer.o
ifeq ($(GPU), 1) 
LDFLAGS+= -lstdc++ 
